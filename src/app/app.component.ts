...
export class AppComponent {
  ...
  onChange(category: string, event: any) {
   ...
   //////////////////////////////////////////////////getCoursesByID///////////////////////////////////////////////////////////////
   debugger    
   let getCoursesByID = this.appSettingsService.getCoursesByID(125);
       console.log(getCoursesByID);
   ////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
   
   //////////////////////////////////////////////////getStudentCourses///////////////////////////////////////////////////////////////
   debugger
   let getStudentCourses = this.appSettingsService.getStudentCourses(1239);
   console.log(getStudentCourses);
   ////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
  }
  getAllCourses() {
    this.appSettingsService.getCourses().subscribe(data => {
      this.res = data
  ...
  getStudentCourses() {
    // this.appSettingsService.getStudentCourses(this.id).subscribe(data => {
      // this.res = data
